...
export function ContactForm() {
  ...
  const content = useContentBlock('home', 'contact', {
  ...
  return (
    <section className="py-16 sm:py-20 bg-white" id="contact">
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
        <div>
          <span className="text-[9px] sm:text-[10px] tracking-[2px] sm:tracking-[3px] uppercase text-crimson mb-4 sm:mb-5 block">{content.subtitle}</span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-6 sm:gap-8">
            {settings.contact_address && (
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-charcoal font-light whitespace-pre-line">
                  {settings.contact_address}
                </p>
              </div>
            )}
            {(settings.contact_email || settings.contact_phone) && (
              <div>
                ...
                <p className="text-[12px] sm:text-[13px] text-charcoal font-light whitespace-pre-line">
                  {[settings.contact_email, settings.contact_phone].filter(Boolean).join('\n')}
                </p>
              </div>
            )}
          </div>
