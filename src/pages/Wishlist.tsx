...
// For now we use a static list of mock wishlist items
const MOCK_WISHLIST = MOCK_PRODUCTS.slice(0, 3);
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-baseline gap-2">
                        <span className="text-[15px] font-medium text-crimson">GBP {product.price.toFixed(2)}</span>
                        {product.oldPrice && <span className="text-[12px] text-silver line-through">GBP {product.oldPrice.toFixed(2)}</span>}
                      </div>
                    </div>
                    <div className="flex gap-2 mt-4 pt-4 border-t border-silver">
                      ...
                      <button className="w-10 flex items-center justify-center border border-silver text-mid-gray hover:border-crimson hover:text-crimson transition-colors">
                        <Trash2 size={14} />
                      </button>
                    </div>
                  </div>
